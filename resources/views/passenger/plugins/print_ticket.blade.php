...
@section('content')
    <div class="d-flex flex-column p-2" style="border-left:6px dashed blue;background-color: lightgrey;">
        <div class="mb-3 align-self-center" id="here">
            <img class="ps-2 float-left w-30" src="{{ asset('images/lamata_logo.png') }}" alt="">
            @if ($ticket->is_paid)
                <span class="lead text-info">{!! DNS1D::getBarcodeSVG("$ticket->ticket_no", 'LAMATA') !!}</span>
            @else
        ...
        @if ($ticket->type == 'trip')
            ...
            @else
                <div class="d-flex justify-content-center mb-2">
                    {!! DNS1D::getBarcodeSVG("$ticket->ticket_no", 'LAMATA', 2, 60) !!}
                </div>
            @endif
        ...
        @if ($ticket->type == 'cargo')
            ...
            <div class="align-self-center">
        @endif
        <p class="font-italic text-dark text-sm text-center mb-0">Thanks for choosing LAMATA</p>
